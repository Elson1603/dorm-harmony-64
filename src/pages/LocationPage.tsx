    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1 w-full">
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="bg-white rounded-xl border border-muted grid grid-cols-1 md:grid-cols-2 gap-0 overflow-hidden items-stretch divide-y md:divide-y-0 md:divide-x divide-muted">
            {/* Map */}
            <div className="flex flex-col justify-center items-center p-6 min-h-[260px]">
              <iframe
                ...
                style={{ border: 0, width: '100%', height: '240px', borderRadius: '0.75rem', display: 'block', maxWidth: 420 }}
                allowFullScreen
                loading="lazy"
            ...
            <div className="flex flex-col justify-center p-6 min-h-[260px]">
              ...
              <div className="bg-muted/40 rounded-lg p-4 text-lg text-muted-foreground">
          ...
          {/* Directions & Accessibility below grid */}
